  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:scale-105 shadow-medium hover:shadow-strong transition-bounce font-semibold",
        healing: "bg-healing text-healing-foreground hover:bg-healing/90 shadow-soft transition-smooth",
        calm: "bg-calm text-calm-foreground hover:bg-calm/90 shadow-soft transition-smooth",
        saffron: "bg-saffron text-saffron-foreground hover:bg-saffron/90 shadow-soft transition-smooth",
        soft: "bg-primary-soft text-primary hover:bg-primary-soft/80 border border-primary/10 transition-smooth"
      },
      size: {
